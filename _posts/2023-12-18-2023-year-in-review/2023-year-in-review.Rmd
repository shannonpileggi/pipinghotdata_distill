...
```{r, eval=TRUE, echo=FALSE}
#| fig.cap: > 
#|    Returning home from our family beach vacation, with the massive
#|    stuffed snake that we won at the arcade.
#| fig.alt: > 
#|    Photo taken from the front seat of a car looking back; two girls are wearing head 
#|    phones and looking down at ipads. In between is a giant pink stuffed snake 
#|    with bright yellow eyes.
knitr::include_graphics("img/snakey.jpg")
```
