...
#| fig.cap: > 
#|   Artwork by [`@allison_horst`](https://twitter.com/allison_horst?lang=en). Except in my case, I just needed 12 days.
#| fig.alt: > 
...
1. When I open up my R project, I now need to remember to pull before I start working on my website.

2. I like using a [branch approach](https://www.pipinghotdata.com/posts/2021-04-01-deploy-previews-with-netlifly/){target="_blank"} to writing blog posts, and now I will have self-induced merge conflicts between my older `README` and the automatically updated `README`.
