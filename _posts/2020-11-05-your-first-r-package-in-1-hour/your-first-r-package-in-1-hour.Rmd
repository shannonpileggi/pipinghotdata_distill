...
The `usethis` package has some handy functions to quickly connect your local package to a GitHub repository. 
...
For more references on using git / GitHub, see Jenny Bryan's [Happy Git and GitHub for the useR](https://happygitwithr.com/) or [Ch 18](https://r-pkgs.org/) in R Packages by Jenny Bryan and Hadley Wickham.  
...
|  3. Connect to GitHub repository.       | `usethis::use_git()`, `usethis::use_github()`|
|  4. Check build.                        | `devtools::check()`                          | 
|  5. Add a license.                      | `usethis::use_mit_license("Your name")`      |
|  6. Check build.                        | `devtools::check()`                          |
|  7. Create a new function.              | `usethis::use_r("function")`                 |
