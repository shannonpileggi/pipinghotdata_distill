...
For more references on using git / GitHub, see Jenny Bryan's [Happy Git and GitHub for the useR](https://happygitwithr.com/) or [Ch 18](https://r-pkgs.org/git.html) in R Packages by Hadley Wickham and Jenny Bryan.  
