...
<aside>
_Added 2021-10-13:_ Mattan Ben-Schachar contributed [two alternative solutions on Twitter](https://twitter.com/mattansb/status/1448150889747910661?s=20){target="_blank"}, one by mean centering and another using the {correlation} package. Another approach suggested by Bryan Shalloway is to compute a [weighted correlation](https://twitter.com/brshallo/status/1448165143288844288){target="_blank"}, which provides a reasonable estimate as well! `(123*0.72 + 68*0.60 + 151*0.58)/342 = 0.634`
</aside>
