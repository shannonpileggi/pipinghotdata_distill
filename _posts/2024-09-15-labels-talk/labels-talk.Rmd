...
After to two previous rejections on related submissions, I was especially excited to finally have a talk accepted.
...
To learn more about Articulation's coaching and approach, watch the [Data Science Hangout](https://posit.co/data-science-hangout/acacia-duncan-and-blythe-coons/) with Articulation coaches Acacia Duncan and Blythe Coons.
...
It is hard to estimate how much time goes into preparing a talk. 
I worked on the talk pretty much continuously, bit by bit when I could, starting about 5 weeks before the talk until the day before the talk. 
...
Receiving multiple rejections is not pleasant, but in retrospect I am glad it happened this way. The talk would not have been the same if either of the prior submissions had been accepted. 
