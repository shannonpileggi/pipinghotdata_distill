...
I am grateful that the posit::conf(2023) program committee wrote the blog post 
[How we build the posit::conf() program](https://posit.co/blog/how-we-build-the-positconf-program/). To paraphrase,
the committee is looking for talks that

1. contain actionable and impactful insights.

2. are of broad interest.

This post was published after my 2021 and 2023 rejections. Understanding
...
that could benefit from either (1) workflows starting with labelled data, or (2)
workflows that create labelled data. And since not many were talking about it,
I wanted to share what I could via posit::conf in hopes of reaching large audience. However,
if my 2024 submission was not accepted, I doubt I would have tried on the same 
topic again.
