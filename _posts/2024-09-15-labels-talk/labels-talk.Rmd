...
In this post I share the previous abstracts I submitted and how I iterated on the submissions.
...
Having goals at fixed timepoints helped to pace the work, and I incorporated both the coach's and fellow speakers  diverse feedback at each stage.
...
However, not all portions of the talk, nor the full talk, were practiced during Articulate, and so the full content had not yet been pressure tested.
I felt that I had tried too hard to get this talk on the program to have any obvious misses, big or small.
So after the Articulation training completed, I invited five friends, a mix of those both familiar and not with the topic, for an hour long meeting in which I presented for the full talk and listened to feedback. 
It is quite sobering when you think you are "done" with a talk and realize you aren't quite there yet. 😅 
I am so glad I did this extra step, as every change suggested was spot on.
