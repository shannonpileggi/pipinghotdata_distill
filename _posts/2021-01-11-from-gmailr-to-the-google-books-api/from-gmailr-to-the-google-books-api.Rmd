...
Alternative solutions to these challenges are welcome! You can download `books.rda` (which contains `message_body`, `books_1`, and `books_2`) from my [github repo](){target="_blank"}.
