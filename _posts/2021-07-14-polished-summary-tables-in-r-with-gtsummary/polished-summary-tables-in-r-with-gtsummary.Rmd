...
From this summary table, I can infer that there are 30,389 records in the years 2015 and 2017; 25,385 of them have non-missing values and 5,004 have missing values. The percents shown in the table are the percent of the non-missing base n; that is, 12,138 / 25,385 is 48%.
...
The `gtsummary` package has readable output that is easily customizable with a variety of export options. Try it out!

as_tibble(gt_table) %>%
  write_xlsx("pulse_dat.xlsx")
