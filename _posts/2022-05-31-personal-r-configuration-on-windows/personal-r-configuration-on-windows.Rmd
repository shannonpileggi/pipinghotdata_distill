...
These locations may work well for some users, and others may want to change the default location. I modified my default location to be the same as my R installation using the [`.Renviron`](#renviron) configuration file (demonstrated below).
