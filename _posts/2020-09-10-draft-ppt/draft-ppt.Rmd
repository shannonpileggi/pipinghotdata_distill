...
Note that this function does open and close Power Point for each slide created, so more
slides will take longer to export.  This particular export takes a while due to the 
number of slides and the density of points on some slides.  
