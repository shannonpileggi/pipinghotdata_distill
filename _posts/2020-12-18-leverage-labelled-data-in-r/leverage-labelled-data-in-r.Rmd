...
signed `class`, which consists of assignments like `numeric`, `character`, and `factor`, among others. When labelled features are present, the `haven` package assigns a class of `haven_labelled`. This is important to know as some packages that you work with may have methods for `haven_labelled` objects, but many may not.
