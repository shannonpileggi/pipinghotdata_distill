...
test_that("correct", {
  # evaluate output produced ----
  expected_write <- write_rladies(1)
  expect_s3_class(expected_write, "character")
  # ----
  expected_1 <- compose_rladies(1)
  #expected_2 <- compose_rladies(1:2)
  expect_s3_class(expected_1, "character")
})
