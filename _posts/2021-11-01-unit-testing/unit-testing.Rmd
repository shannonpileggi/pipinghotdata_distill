...
* What can we test in `compute_corr()`?
  
* How much of the function code is covered by tests?

* How can you test safe user inputs?
...
The **1**_x_ on the left hand side counts how many times that line of code has been executed when you ran your test suite.
...
1. `(19:50)` When do you write tests? 
...
2. `(22:19)` When I start writing tests, I get sucked into a rabbit hole of tests. 
...
3. `(23:53)` Is it fair to say that you should consider problems that tripped you 
...
4. `(32:50)` Can we write test that statements with more descriptive errors?
...
5. `(37:00)` How is the percent coverage from `covr::report()` calculated?
...
6. `(38:10)` You mentioned earlier that when you fix a bug, that is a good time
...
7. `(39:27)` How is running tests different than trying out different data 
...
8. `(53:50)` Do you have advice on how to choose the data to feed into the 
expected object?
...
9. `(55:57)` Do you commonly see test that used against a script instead of a function?
