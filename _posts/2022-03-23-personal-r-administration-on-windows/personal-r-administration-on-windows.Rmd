...
packages are installed in [global package cache](https://www.jumpingrivers.com/blog/new-features-r420/){target="_blank} which is shared across all projects. My cache is located at `C:\Users\pileggis\AppData\Local\R\cache\R\renv` (confirm this!).
