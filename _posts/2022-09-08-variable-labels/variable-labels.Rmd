...
description: |
  Labeled data workflows with applications in data dictionaries, summary tables,
...
to certain conventions incompatible with detailed column names. 

A labeled data workflow is one in which readable variable _labels_ are assigned to variables.
Two reasons to adopt a labeled workflow are:
...
2. If you have good variable names, but want something more descriptive or
...
falls a bit short. If there is a slicker solution to automatically
...
my data products. I am curious if the set up is worthwhile for others as well!
