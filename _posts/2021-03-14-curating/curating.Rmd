...
description: |
  From preparation to cultivating connections 
...
_Still open to title suggestions!_

_open to alternative images_
...
* from Ale Segura
   * 1 getting over imposter syndrome
   * 2 passing the torch
   * 3 the temporary fame

# TL; DR

_needs more work_

In February 2021 I curated the [`@WeAreLadies`](https://twitter.com/WeAreRLadies){target="_blank"} rotating Twitter account. I tweeted [a lot](https://twitter.com/spcanelon/status/1363518469782843396){target="_blank"} and had some [blunders](https://twitter.com/PipingHotData/status/1364183660744896513){target="_blank"}; it was a great opportunity to share knowledge, connect with others with similar interests, and learn something in return.
...
My personal strategy for combating imposter syndrome is to prepare. For my curating week, my preparation involved reflecting on past curators and preparing some content in advance. I hope this post helps you to prepare and motivates you to sign up. `r emo::ji("wink")`
...
seriously. I notified my manager that I was curating, and I discussed potential work-related content with her. One idea was approved and another was reasonably denied. This honest conversation alleviated my concerns about Twitter curation potentially impacting my work. Discussing this with her also facilitated new awareness about my passions - my manager was not aware of R-Ladies, and she was enthusiastic and supportive.
