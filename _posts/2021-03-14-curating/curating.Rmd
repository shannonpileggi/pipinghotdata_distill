...
```{r, fig.cap="Three polls and their follow-up discussion; hover over tiles to view tweets and click on tiles to go to links on Twitter.", fig.align="Visual presentation of polls with tiles; days of the week across x-axis, tweet number across y-axis."}
girafe(ggobj = p,
...
Between prepared and ad-hoc content and discussions with followers, I tweeted a lot! (At least for me.)  Here is a [summary thread](https://twitter.com/spcanelon/status/1363518469782843396){target="_blank"} of my tweets for the week. My tweets were not perfect, and that is okay. I messed up threads, had typos, and shared deprecated code, among other things. Check out my [blooper reel](https://twitter.com/PipingHotData/status/1364183660744896513){target="_blank"}^[A blooper is an American English term for an embarrassing mistake, which is often humorous in retrospect.] for tweets that I bungled.
...
Thank you to [Maëlle Salmon](https://twitter.com/ma_salmon){target="_blank"} and [Alison Hill](https://twitter.com/apreshill){target="_blank"} for encouraging me to write this - this might not have happened without you! Thank you also to Maëlle Salmon, Alison Hill, and [Ale Segura](https://twitter.com/alehsegura13){target="_blank"} for your suggestions; I truly appreciate your sharp eyes and thoughtful feedback.  `r emo::ji("purple heart")`
