...
working title: Curating a public garden

working description: Before, during, and after my week curating for `@WeAreRLadies` on Twitter
...
In February 2021 I served as the [`@WeAreLadies`](https://twitter.com/WeAreRLadies){target="_blank"} rotating curator. I tweeted [a lot](https://twitter.com/spcanelon/status/1363518469782843396){target="_blank"} and had some [blunders](https://twitter.com/PipingHotData/status/1364183660744896513){target="_blank"}, but most importantantly I learned how to create my own public garden. 
...
because I hoped by then I should be recovered from an intense Q4 work cycle;
...
I signed up to curate in 2021, giving myself three months notice to start thinking
about content. After I signed up, I started jotting down quick content ideas as they popped into my head.

_some overlap here with drafting content section, where best placed?_
...
seriously.  First, I notified my manager that I was curating - my manager had no idea that R-Ladies even existed, and she was enthusiastic and supportive. Next, I discussed potential work-related content with her. One idea was given the green light and another was reasonably denied. I am very glad we had this honest conversation.

Additionally, I considered how to style visual content; I asked on [R-Ladies slack](https://rladies-community-slack.herokuapp.com/){target="_blank"} about R-Ladies styles, and I was directed to the xaringan R-Ladies [css](https://github.com/yihui/xaringan/tree/master/inst/rmarkdown/templates/xaringan/resources){target="_blank"} and the R-Ladies [branding](https://guide.rladies.org/organization/tech/brand/){target="_blank"} guides. I developed visual layouts like [this one](https://twitter.com/WeAreRLadies/status/1363144545677017089){target="_blank"} using the Google slide [template](https://docs.google.com/presentation/d/1sriC2biLPYza_TtGiZkrNDsv3AMg6dvhqw2yit4wNnA/edit){target="_blank"} and R code gifs using [custom CSS and `{flipbookr}`](https://www.pipinghotdata.com/posts/2021-03-08-r-ladies-styled-code-gifs-with-xaringan-and-flipbookr/){target="_blank"}.
...
https://giphy.com/gifs/trainline-spy-l0HUbESbGqYn8kNlC

https://giphy.com/gifs/the-matrix-neo-thomas-anderson-fV0oSDsZ4UgdW
...
Between prepared and ad-hoc content and discussions with followers, I tweeted a lot! (At least for me.)  Here is a [summary thread](https://twitter.com/spcanelon/status/1363518469782843396){target="_blank"} of my tweets for the week. My tweets were not perfect, and that is OK. I messed up threads, had typos, and shared deprecated code, among other things. Check out my [blooper reel](https://twitter.com/PipingHotData/status/1364183660744896513){target="_blank"} for tweets that I bungled.
