...
✍️ The last post was published **`r days_last_post`** days ago ([`r titles[1]`](`r links[1]`)). As advised by Yihui Xie, I try to write like nobody is reading; but your
...
```{r}
pkgs <- c("rmarkdown", "knitr", "magrittr", "ggplot2", "stringr", "dplyr", "xml2", "lubridate")
