...
knitr::include_graphics("WDS-Curating.svg")
```
...
xfun::embed_file(here::here("_talks", "2021-10-07-be-great-and-curate", "WDS-Curating.pdf"), text = "Download the poster")
```
