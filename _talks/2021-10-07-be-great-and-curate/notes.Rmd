...
I imagine two things holding you back from considering a rotatin curating position are imposter syndrom and discomfort with Twitter. This was certainly true for me as well. 
...
In its most basic form, a tweet is just plain text, and you probably know, with some emojis. But you can share a broad range of content, including gifs, images, memes, code, and flyers. 

For my curating week, I wanted to share both code gifs and a couple of formatted slide layouts. I didn't have my own colors or fonts to use, nor did I feel like investing time in that, so I relied on the R-Ladies style guides that already had colors, fonts, and example layouts readily available.
